...
video_path = r'C:\Users\5XIN\Downloads\5229647-uhd_3840_2160_30fps.mp4'
cap = cv2.VideoCapture(video_path)
model = YOLO('yolov8n.pt')

classnames = []
with open(r'C:\Users\5XIN\Desktop\acadamic\Mini Project\traff\Vehicle-Counting-in-Lanes\classes.txt', 'r') as f:
